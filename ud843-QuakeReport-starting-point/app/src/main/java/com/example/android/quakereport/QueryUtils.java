...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link EarthquakeElement} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<EarthquakeElement> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<EarthquakeElement> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONObject responseConverted = new JSONObject(SAMPLE_JSON_RESPONSE);

            JSONArray earthquakesAsArray = responseConverted.optJSONArray("features");

            for (int i = 0; i<earthquakesAsArray.length(); i++) {
                JSONObject feature = earthquakesAsArray.optJSONObject(i);
                ...
                if(properties != null) {
                    ...
                    earthquakes.add(new EarthquakeElement(magnitude, place, time, url));
                }
            }
